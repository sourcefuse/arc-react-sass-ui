...
import { PermissionGuardWrapper } from "Components/PermissionGuardWrapper";
  ...
  return (
    <Box sx={{ display: "flex" }}>
      <AppBar
        ...
        data-testid="sidenav"
        userName={
          userData ? `${userData.given_name} ${userData.family_name}` : "User"
        }
      />
      <Box>
        <Toolbar />
