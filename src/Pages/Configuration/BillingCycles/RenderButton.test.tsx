...
describe("RenderButton Component", () => {
  ...
  const initialValues = { id: "", cycleName: "" };
  const mockValues = { id: "1", cycleName: "Test Billing Cycle" };
  ...
  it("disables Submit button when form is invalid or not dirty", () => {
    renderComponent({ initialValues: { id: "", cycleName: "" } });
    const submitButton = screen.getByText("Submit");
    expect(submitButton).toBeDisabled();
  });

  it("renders Update button when form has an ID", () => {
    renderComponent({ initialValues: mockValues });
